...
# {urn:ws.rsys.com}ContentLibraryFolderResult
...
# {urn:ws.rsys.com}ItemData
#   item - SOAP::SOAPBase64
class ItemData
  attr_accessor :item
...
class ExceptionCode < ::String
  ...
  UNRECOVERABLE_EXCEPTION = new("UNRECOVERABLE_EXCEPTION")
end
...
# {urn:ws.rsys.com}mergeTriggerEmail
#   recordData - RecordData
#   mergeRule - ListMergeRule
#   campaign - InteractObject
#   triggerData - TriggerData
...
# {urn:ws.rsys.com}mergeTriggerEmailResponse
class MergeTriggerEmailResponse < ::Array
end
...
# {urn:ws.rsys.com}deleteProfileExtensionMembers
...
class DeleteProfileExtensionMembers
  ...
  def initialize(profileExtension = nil, queryColumn = nil, idsToDelete = [])
...
# {urn:ws.rsys.com}deleteProfileExtensionMembersResponse
class DeleteProfileExtensionMembersResponse < ::Array
end
...
# {urn:ws.rsys.com}listContentLibraryFolders
#   startingPath - SOAP::SOAPString
#   showTree - SOAP::SOAPBoolean
class ListContentLibraryFolders
  attr_accessor :startingPath
  attr_accessor :showTree

  def initialize(startingPath = nil, showTree = nil)
    @startingPath = startingPath
    @showTree = showTree
  end
end

# {urn:ws.rsys.com}listContentLibraryFoldersResponse
class ListContentLibraryFoldersResponse < ::Array
end

# {urn:ws.rsys.com}doesContentLibraryFolderExist
#   path - SOAP::SOAPString
...
# {urn:ws.rsys.com}doesContentLibraryFolderExistResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}deleteContentLibraryFolder
#   folderName - SOAP::SOAPString
...
# {urn:ws.rsys.com}deleteContentLibraryFolderResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}createContentLibraryFolder
#   path - SOAP::SOAPString
...
# {urn:ws.rsys.com}createContentLibraryFolderResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}createContentLibraryItem
#   contentLibraryLocation - InteractObject
#   type - SOAP::SOAPString
#   itemData - ItemData
class CreateContentLibraryItem
  attr_accessor :contentLibraryLocation
  attr_accessor :type
  attr_accessor :itemData

  def initialize(contentLibraryLocation = nil, type = nil, itemData = nil)
    @contentLibraryLocation = contentLibraryLocation
    @type = type
    @itemData = itemData
  end
end

# {urn:ws.rsys.com}createContentLibraryItemResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}setContentLibraryItem
#   contentLibraryLocation - InteractObject
#   type - SOAP::SOAPString
#   itemData - ItemData
...
# {urn:ws.rsys.com}setContentLibraryItemResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}deleteContentLibraryItem
#   contentLibraryLocation - InteractObject
class DeleteContentLibraryItem
  attr_accessor :contentLibraryLocation

  def initialize(contentLibraryLocation = nil)
    @contentLibraryLocation = contentLibraryLocation
  end
end

# {urn:ws.rsys.com}deleteContentLibraryItemResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}copyContentLibraryItem
#   sourceObject - InteractObject
#   destinationObject - InteractObject
class CopyContentLibraryItem
  attr_accessor :sourceObject
  attr_accessor :destinationObject

  def initialize(sourceObject = nil, destinationObject = nil)
    @sourceObject = sourceObject
    @destinationObject = destinationObject
  end
end

# {urn:ws.rsys.com}copyContentLibraryItemResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}moveContentLibraryItem
#   sourceObject - InteractObject
#   destinationObject - InteractObject
...
# {urn:ws.rsys.com}moveContentLibraryItemResponse
#   result - SOAP::SOAPBoolean
...
# {urn:ws.rsys.com}getContentLibraryItem
#   sourceObject - InteractObject
class GetContentLibraryItem
  attr_accessor :sourceObject

  def initialize(sourceObject = nil)
    @sourceObject = sourceObject
  end
end

# {urn:ws.rsys.com}getContentLibraryItemResponse
#   name - SOAP::SOAPString
#   type - SOAP::SOAPString
#   itemData - ItemData
class GetContentLibraryItemResponse
  ...
  def initialize(name = nil, type = nil, itemData = nil)
    @name = name
    @type = type
    @itemData = itemData
  end
...
# {urn:fault.ws.rsys.com}UnrecoverableErrorFault
#   exceptionCode - ExceptionCode
#   exceptionMessage - SOAP::SOAPString
class UnrecoverableErrorFault < ::StandardError
  attr_accessor :exceptionCode
  attr_accessor :exceptionMessage
