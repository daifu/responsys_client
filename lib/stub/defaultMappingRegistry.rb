...
module DefaultMappingRegistry
  ...
  EncodedRegistry.register(
    :class => TriggerData,
    :schema_type => XSD::QName.new(NsWsRsysCom, "TriggerData"),
    :schema_element => [
      ["optionalData", "OptionalData[]", [1, nil]]
    ]
  )
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsWsRsysCom, "ContentLibraryFolderResult"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    :class => ItemData,
    :schema_type => XSD::QName.new(NsWsRsysCom, "ItemData"),
    :schema_element => [
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "mergeTriggerEmail"),
    :schema_element => [
      ["recordData", "RecordData"],
      ["mergeRule", "ListMergeRule"],
      ["campaign", "InteractObject"],
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "mergeTriggerEmailResponse"),
    :schema_element => [
      ["result", "TriggerResult[]", [1, nil]]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "deleteProfileExtensionMembers"),
    :schema_element => [
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "deleteProfileExtensionMembersResponse"),
    :schema_element => [
      ["result", "DeleteResult[]", [1, nil]]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "listContentLibraryFolders"),
    :schema_element => [
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "listContentLibraryFoldersResponse"),
    :schema_element => [
      ["result", "ContentLibraryFolderResult[]", [1, nil]]
    ]
  )

  LiteralRegistry.register(
    :class => DoesContentLibraryFolderExist,
    :schema_name => XSD::QName.new(NsWsRsysCom, "doesContentLibraryFolderExist"),
    :schema_element => [
      ["path", "SOAP::SOAPString"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "doesContentLibraryFolderExistResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "deleteContentLibraryFolder"),
    :schema_element => [
      ["folderName", "SOAP::SOAPString"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "deleteContentLibraryFolderResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "createContentLibraryFolder"),
    :schema_element => [
      ["path", "SOAP::SOAPString"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "createContentLibraryFolderResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "createContentLibraryItem"),
    :schema_element => [
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "createContentLibraryItemResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "setContentLibraryItem"),
    :schema_element => [
      ["contentLibraryLocation", "InteractObject"],
      ["type", "SOAP::SOAPString"],
      ["itemData", "ItemData"]
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "setContentLibraryItemResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "deleteContentLibraryItem"),
    :schema_element => [
      ["contentLibraryLocation", "InteractObject"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "deleteContentLibraryItemResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "copyContentLibraryItem"),
    :schema_element => [
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "copyContentLibraryItemResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "moveContentLibraryItem"),
    :schema_element => [
      ["sourceObject", "InteractObject"],
      ["destinationObject", "InteractObject"]
    ]
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "moveContentLibraryItemResponse"),
    :schema_element => [
      ["result", "SOAP::SOAPBoolean"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "getContentLibraryItem"),
    :schema_element => [
      ["sourceObject", "InteractObject"]
    ]
  )
  ...
  LiteralRegistry.register(
    ...
    :schema_name => XSD::QName.new(NsWsRsysCom, "getContentLibraryItemResponse"),
    :schema_element => [
      ["name", "SOAP::SOAPString"],
      ["type", "SOAP::SOAPString"],
      ["itemData", "ItemData"]
  ...
  LiteralRegistry.register(
    :class => UnrecoverableErrorFault,
    :schema_name => XSD::QName.new(NsFaultWsRsysCom, "UnrecoverableErrorFault"),
    :schema_element => [
      ["exceptionCode", "ExceptionCode"],
      ["exceptionMessage", "SOAP::SOAPString"]
    ]
