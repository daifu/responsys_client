...
class ResponsysWS < ::SOAP::RPC::Driver
  ...
  Methods = [
    ...
    [ "",
      ...
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"TriggeredMessageFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"TriggeredMessageFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnrecoverableErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnrecoverableErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      "mergeTriggerEmail",
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "mergeTriggerEmail"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "mergeTriggerEmailResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"TriggeredMessageFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"TriggeredMessageFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    ...
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "deleteProfileExtensionMembers"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "deleteProfileExtensionMembersResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
    ...
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "listContentLibraryFolders"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "listContentLibraryFoldersResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"FolderFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"FolderFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "doesContentLibraryFolderExist"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "doesContentLibraryFolderExistResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"FolderFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"FolderFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "deleteContentLibraryFolder"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "deleteContentLibraryFolderResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"FolderFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"FolderFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "createContentLibraryFolder"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "createContentLibraryFolderResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"FolderFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"FolderFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "createContentLibraryItem"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "createContentLibraryItemResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"DocumentFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"DocumentFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "setContentLibraryItem"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "setContentLibraryItemResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"DocumentFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"DocumentFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "deleteContentLibraryItem"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "deleteContentLibraryItemResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"DocumentFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"DocumentFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ],
    [ "",
      ...
      [ [:in, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "getContentLibraryItem"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "urn:ws.rsys.com", "getContentLibraryItemResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {"DocumentFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"DocumentFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}, "UnexpectedErrorFault_"=>{:ns=>"urn:ws.rsys.com", :name=>"UnexpectedErrorFault", :namespace=>nil, :use=>"literal", :encodingstyle=>"document"}} }
    ]
